...
parser.add_argument('--iou_threshold',  type=float, default=2, help='iou_threshold for kmeans')
...
for batch, data in iterator:
    if args.dataset == 'coco':
        ...
        image, _ = data
    IOU_metric = UnsupervisedMaskIoUMetric(matching="hungarian", ignore_background = True, ignore_overlaps = True).cuda()
