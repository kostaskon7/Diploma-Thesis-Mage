...
elif args.which_encoder == 'mae_vitb16' or args.which_encoder == 'moca_vitb16':
    args.max_tokens = int((args.val_image_size/16)**2)
...
with torch.no_grad():
    ...
    df_results = pd.DataFrame([[mbo_i.item(), mbo_c.item(), ari.item(),  val_mse, mbo_i_slot.item(), mbo_c_slot.item(), ari_slot.item(), fg_iou.item(), fg_iou_slot.item()]], 
                 columns=['mBO_i', 'mBO_c', 'FG-ARI',  'MSE', 'mBO_i_slots', 'mBO_c_slots', 'FG-ARI_slots', 'fg_IoU', 'fg_IoU_slots'])
