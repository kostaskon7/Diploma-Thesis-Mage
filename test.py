...
class MAGEVisionTransformer(timm.models.vision_transformer.VisionTransformer):
    """ Vision Transformer with support for global average pooling
    """
    def __init__(self, global_pool=False,vqgan_ckpt_path='./vqgan_jax_strongaug.ckpt', **kwargs):
        super(MAGEVisionTransformer, self).__init__(**kwargs)
